    ...
    <div class="content">
        ...
        <article class="article-content">
            ...
            <div class="article-social">
                <a href="javascript:;" data-action="ding" data-id="<?=$model->id?>" id="Addlike" class="action"><i class="fa fa-heart-o"></i><?=yii::t('frontend', 'Like')?> (<span class="count"><?= $model->articleLikeCount ?></span>)</a>
